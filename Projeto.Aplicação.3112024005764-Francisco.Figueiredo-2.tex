...
\titulo{
	Criação de arquitetura de parâmetros configuráveis on-line para aplicações backend C\# e AKS em nuvem Azure para o aplicativo CAIXA
}%
...
\begin{document}
	...
	% -----------------------------------------------------------------
		...
		\ImprimirSimOuNao[Sim]{
			\begin{epigrafe}
				...
				{\begin{minipage}{.6\textwidth}
					\begin{flushright}
						\textit{``Um homem é uma fração cujo numerador corresponde ao que ele é, enquanto o denominador é o que acredita ser.``\\
							(Leon Tolstoi)}
					\end{flushright}
				\end{minipage}}%
			\end{epigrafe}
		...
		\ImprimirSimOuNao[Sim]{
			...
			\begin{resumo}
			 O artigo apresenta uma aplicação prática da matemática na engenharia, com o objetivo de calcular a área alagada da barragem do rio Bonito. Foram utilizadas aproximações para integrais definidas e ajustes de curvas, além de softwares matemáticos para facilitar os cálculos. O estudo destaca a importância da integração da tecnologia e do ensino de matemática para o desenvolvimento de habilidades importantes para a vida social e para o mundo do trabalho. Em resumo, o artigo apresenta uma aplicação interessante da matemática na engenharia, que pode ser útil para profissionais da área e estudantes que desejam aprimorar seus conhecimentos.\\
			 

			 \textbf{Palavras-chave}: Integral definida, cálculo.
			\end{resumo}
		}
...
\chapter{Problematização}
	...
	\include{02_problematizacao}

\chapter{Justificativa}

	\include{03_justificativa}

\chapter{Fundamentação Teórica}

	\include{04_fundamentacao_teorica}

\chapter{Percurso Metodológico}

	\include{05_percuso_metodologico}

\chapter{Resultados Esperados}

	\include{06_resultados}
